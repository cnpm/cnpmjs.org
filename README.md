...
* Use the private npm service provided by Alibaba Cloud DevOps which build with cnpm. [http://packages.aliyun.com/](http://packages.aliyun.com/?channel=pd_cnpm_github)
