...
describe('controllers/web/badge.test.js', function() {
  ...
  describe('GET /badge/v/:name.svg', function() {
    it('should show blue version on >=1.0.0 when package exists', function(done) {
      const pkg = utils.getPackage('@cnpmtest/badge-test-module', '1.0.1', utils.admin);
      request(registry)
      .put('/' + pkg.name)
    ...
    it('should show tag', function(done) {
      const pkg = utils.getPackage('@cnpmtest/badge-test-module', '2.0.1', utils.admin, 'v2');
      request(registry)
      .put('/' + pkg.name)
      .set('authorization', utils.adminAuth)
      .send(pkg)
    ...
    it('should support custom subject', function(done) {
      const pkg = utils.getPackage('@cnpmtest/badge-test-module', '3.0.1', utils.admin, 'v3');
      request(registry)
      .put('/' + pkg.name)
      .set('authorization', utils.adminAuth)
      .send(pkg)
    ...
    it('should support 1.0.0-beta1', function(done) {
      const pkg = utils.getPackage('@cnpmtest/badge-test-module', '1.0.0-beta1', utils.admin);
      request(registry)
      .put('/' + pkg.name)
      .set('authorization', utils.adminAuth)
      .send(pkg)
    ...
    it('should show green version on <1.0.0 & >=0.1.0 when package exists', function(done) {
      const pkg = utils.getPackage('@cnpmtest/badge-test-module', '0.1.0', utils.admin);
      request(registry)
      .put('/' + pkg.name)
      .set('authorization', utils.adminAuth)
      .send(pkg)
    ...
    it('should show green version on <0.1.0 & >=0.0.0 when package exists', function(done) {
      const pkg = utils.getPackage('@cnpmtest/badge-test-module', '0.0.0', utils.admin);
      request(registry)
      .put('/' + pkg.name)
      .set('authorization', utils.adminAuth)
      .send(pkg)
  ...
  describe('GET /badge/d/:name.svg', function() {
    it('should show downloads count', function(done) {
      const pkg = utils.getPackage('@cnpmtest/badge-download-module', '1.0.1', utils.admin);
      request(registry)
      .put('/' + pkg.name)
      .set('authorization', utils.adminAuth)
      .send(pkg)
