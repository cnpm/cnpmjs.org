...
const registryApp = require('../../servers/registry');
const webApp = require('../../servers/web');
...
describe('controllers/sync.test.js', function() {
  ...
  const mockPackage = JSON.parse(fs.readFileSync(path.join(fixtures, 'utility.json')));
